...
#define DC_HIGH()           GPIO.out_w1ts = (1 << 21)
#define DC_LOW()            GPIO.out_w1tc = (1 << 21)
#define CS_HIGH()           GPIO.out_w1ts = (1 << 5)
#define CS_LOW()            GPIO.out_w1tc = (1 << 5)
...
//    M5.Lcd.setBrightness(0);
    ...
    M5.Lcd.drawBitmap(0, 0, TFT_WIDTH, TFT_HEIGHT, (uint16_t *)gImage_logoM5);
	delay(1000);
	M5.Lcd.pushImage(0, 0, TFT_WIDTH, TFT_HEIGHT, (uint16_t *)gImage_logoM5);
#else
    M5.Lcd.drawBitmap(0, 0, TFT_HEIGHT, TFT_WIDTH, (uint16_t *)gImage_logoM5);
	delay(1000);
	M5.Lcd.pushImage(0, 0, TFT_HEIGHT, TFT_WIDTH, (uint16_t *)gImage_logoM5);
#endif
...
//
//	r = SPI.transfer(0)<<16;
////	Serial.printf("r1: %X ", r1);
////	r = r1 << 16;
//	r |= SPI.transfer(0)<<8;
////	Serial.printf("r2: %X ", r1);
////	r |= r1	<< 8;
//	r |= SPI.transfer(0);
//	M5.Lcd.endWrite();
//
////	Serial.printf("r3: %X ", r1);
//
//	return r;
//}
//
